...
function test_algorithms(
    ...
    (; test_name, t_end, analytic_sol) = test_case
    ...
    ref_sol = if isnothing(numerical_reference_algorithm_name)
        ...
        ref_alg = get_alg(numerical_reference_algorithm_name, test_case)
    ...
    for algorithm_name in algorithm_names
        alg = get_alg(algorithm_name, test_case)
    ...
    if !isnothing(full_history_algorithm_name)
        history_alg = get_alg(full_history_algorithm_name, test_case)
    ...
    plot = Plots.plot(
        plots...;
        plot_title = "Analysis of $title Methods for \"$test_name\"",
